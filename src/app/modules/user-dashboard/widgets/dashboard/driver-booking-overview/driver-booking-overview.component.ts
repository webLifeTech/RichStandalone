...
@Component({
  selector: 'app-driver-booking-overview',
  standalone: true,
  imports: [
  ...
  templateUrl: './driver-booking-overview.component.html',
  styleUrls: ['./driver-booking-overview.component.scss']
})
export class DriverBookingOverviewComponent {
  @Input() details: any = {
    totalBooked: {},
    bookedData: []
  };
