...
@Component({
  ...
  providers: [DatePipe],
  templateUrl: './mydrivers.component.html',
  styleUrl: './mydrivers.component.scss'
})
export class MyDriversComponent {
  ...
  sortColumn: any = "registrationDate";
  sortOrder: any = "DESC";
  ...
  getTableData() {
    ...
    const body = {
      ...
      "startDate": this.transformDate(startDate, 'MM/dd/yyyy HH:mm:ss'),
      "endDate": this.transformDate(endDate, 'MM/dd/yyyy HH:mm:ss'),
    }
